...
//                + ";bucketName=" + bucketName + ";fileName=" + fileName);
        try {
            ...
            log.info("uploadFile error fileName=" + fileName);
            return false;
        }
    }
...
//                + ";bucketName=" + bucketName + ";objectName=" + objectName);
        try {
            ...
            boolean isExist = minioClient.bucketExists(bucketName);
            if (!isExist) {
                log.info("downloadFile bucketName not exist:bucketName=" + bucketName);
                return false;
            }
            ...
            log.info("downloadFile error objectName=" + objectName);
        }
        return false;
    }
...
//                + ";bucketName=" + bucketName + ";objectName=" + objectName);
        try {
            ...
            boolean isExist = minioClient.bucketExists(bucketName);
            if (!isExist) {
                log.info("deleteFile bucketName not exist:bucketName=" + bucketName);
                return;
            }
            minioClient.removeObject(bucketName, objectName);
        } catch (Exception e) {
            log.info("deleteFile error objectName=" + objectName);
        }
    }
...
//                + ";bucketName=" + bucketName + ";objectNames=" + objectNames);
        try {
            ...
            log.info("deleteFile error objectName=" + objectNames);
        }
    }
...
//                + ";bucketName=" + bucketName + ";objectName=" + objectName);
        try {
            ...
            log.info("getFileInfo error.objectName=" + objectName);
            return null;
        }
    }
